...
{
    public ControlPersonaje player;
    ...
    public void OnEnter(GameObject obj)
    {
        ...
        if (itemsDisplayed[obj].item.Name == "" && itemsDisplayed[obj].item.description == "")
        {
            info.itemName.text = "Nombre de la Descripción";
            info.itemDescription.text = "Aqui aparecerá la descripción del objeto";
        }
        else
        {
            info.itemName.text = itemsDisplayed[obj].item.Name;
            info.itemDescription.text = itemsDisplayed[obj].item.description;
        }
    }
